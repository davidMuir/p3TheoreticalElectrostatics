...
int main() {
	...
	//first_grid.set_conductor(60,25,15,60,triangle);
	first_grid.set_conductor(50,75,15,0,circle);
	...
	sol_fd.set_conductor(60,25,15,60,triangle);

	Fast_Finite_Difference fd1 (sol_fd);
	...
	conductors.new_conductor(60,25,15,60,triangle);
	conductors.new_conductor(50,75,15,0,circle);
	conductors.set_precision(0.00001);
	...
	gp2.add_command("set xrange [0:100]");
	gp2.add_command("set yrange [0:100]");
	...
	gp3.add_command("set xrange [0:100]");
	gp3.add_command("set yrange [0:100]");
